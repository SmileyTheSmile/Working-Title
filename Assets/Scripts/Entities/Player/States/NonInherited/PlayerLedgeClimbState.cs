...
public class PlayerLedgeClimbState : PlayerState
{
    ...
    private Vector2 DetermineCornerPosition()
    {
        ...
        RaycastHit2D hitY = Physics2D.Raycast(core.collisionSenses.ledgeCheckHorizontal.position + (Vector3)(workspace), Vector2.down, core.collisionSenses.ledgeCheckHorizontal.position.y - core.collisionSenses.wallCheck.position.y + 0.15f, core.collisionSenses.whatIsGround);
        float distY = hitY.distance;
        workspace.Set(core.collisionSenses.wallCheck.position.x + (distX * core.movement.facingDirection), core.collisionSenses.ledgeCheckHorizontal.position.y - distY);
        return workspace;
    }
